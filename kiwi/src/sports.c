...
static void window_load(Window *window) {
  ...
  APP_LOG(APP_LOG_LEVEL_INFO, "Sports window loaded");
...
void sports_show(void) {
  const bool animated = true;
  window_stack_push(ui.window, animated);
  APP_LOG(APP_LOG_LEVEL_INFO, "Showing sports window");
}

void sports_init(void) {
  APP_LOG(APP_LOG_LEVEL_INFO, "Initializing sports card...");
  ...
  APP_LOG(APP_LOG_LEVEL_INFO, "Sports card initialized");
}

void sports_deinit(void) {
